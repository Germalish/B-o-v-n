...
public class MemberAction {
            ...
            if (member.getEmail().equals(email)) {
                ...
                while (true) {
                    ...
                    if (MemberAction.checkValidPassword(input)) {
                        ...
                        System.out.println("Mật khẩu dài từ 7 đến 15 ký tự," +
                                " chứa ít nhất 1 ký tự in hoa, 1 ký tự đặc biệt (. , - _ ;). Hãy nhập lại");
                    }
                }
    ...
    public Member dangKy(Scanner scanner) {
        ...
        while (true) {
            ...
            if (checkValidPassword(input)) {
                ...
                System.out.println("Mật khẩu dài từ 7 đến 15 ký tự, chứa ít nhất 1 ký tự" +
                        " in hoa, 1 ký tự đặc biệt (. , - _ ;). Hãy nhập lại");
            }
        }
    ...
    public static boolean checkValidPassword(String password) {
        ...
        if (pattern.matcher(password).find() && pattern1.matcher(password).find()
                && pattern2.matcher(password).find() && pattern3.matcher(password).find()
